(ns todo.backend.db
  "Este namespace gerencia os dados dos 'todos' usando
  um banco de dados persistente SQLite.")
...
(defn initialize-database! 
  "Cria a tabela 'todos' no banco de dados caso não exista"
  []
...
(defn create-todo
  "Cria um novo 'todo', salva no banco e retorna"
  [todo-data]
  (let [
